...
function nonEmptyTitle() {
    //If title exists in localstorage -> error + return
...
function createPost(data) {
    ...
    localStorage.setItem('uwu', JSON.stringify(datesum));
...
function updatePost(formData) {
    let col0 = selectedRowToEdit.cells[0];
    col0.innerHTML = formData.title;
    let col1 = selectedRowToEdit.cells[1];
    col1.innerHTML = formData.date;
    let col2 = selectedRowToEdit.cells[2];
